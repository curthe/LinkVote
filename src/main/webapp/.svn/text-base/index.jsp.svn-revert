...
<script type="text/javascript"
	src="${PATH }/linkVoteApp/jQuery/jquery-3.1.1.js"></script>
<!-- 引入jQuery.form.js插件 -->
<script type="text/javascript"
	src="${PATH }/linkVoteApp/scripts/jQuery.form.js"></script>
<!-- 引入bootstrap框架 -->
		...
		$.ajax({
			...
			success : function(result) {
				...
				$.each(users, function(index, user) {
					...
					user_tr.append(checkBox).append(id_td).append(name_td)
							.append(sex_td).appendTo("#emps_tbl tbody");
				});
			}
		});
	});
